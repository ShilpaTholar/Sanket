        ...
        with sr.Microphone() as source:
                ...
                while True:
                        ...
                        try:
                                ...
                                if(a.lower()=='goodbye' or a.lower()=='good bye' or a.lower()=='bye'):
                                ...
                                elif any(x in a.lower() for x in isl_gif):
                                     ...
                                     for i in a.split():
                                        ...
                                        if(i in isl_gif):
                                            ...
                                            lbl = ImageLabel(root)
                                            lbl.pack()
                                            lbl.load(r'ISL_Gifs/{0}.gif'.format(i.lower()))
                                            img_array = plt.imread(r'ISL_Gifs/{0}.gif'.format(i.lower())) 
                                            # lbl.unload()
                                            root.after(1000, root.destroy)
                                            
                                           
                                            root.mainloop()
                                            # lbl.after(5000,lbl.destroy())
                                            
                                        else:
                                        
                                            for j in range(len(i)):
                                                    if(i[j] in arr):
                                                            ImageAddress = 'letters/'+i[j]+'.jpg'
